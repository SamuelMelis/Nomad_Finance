...
export const ExpensesTab: React.FC = () => {
  ...
  return (
    <div className="pb-24 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {/* Header - Compacted */}
      <div className="flex justify-between items-end mb-4 border-b border-[#18181b]/10 pb-2">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-[#18181b]">Expenses</h2>
        </div>
                  ...
                  {CATEGORIES.map(cat => {
                    ...
                    return (
                      <button
                        ...
                        className={`h-14 rounded-xl flex flex-col items-center justify-center gap-1 transition-all border ${isSelected
